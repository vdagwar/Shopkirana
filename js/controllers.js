        ...
        if ($scope.ClientData != null) {
            ...
            $scope.total= function (data) {
                ...
                var datatopost = {
                    ...
                    TotalAmount: $scope.totalsum + $scope.OneRupeeTotal + $scope.TwoRupeeTotal + $scope.FiveRupeeTotal + $scope.TenRupeeTotal + $scope.TwentyRupeeTotal + $scope.fiftyRupeeTotal + $scope.HunRupeeTotal + $scope.fivehunRupeeTotal + $scope.twohunRupeeTotal,
